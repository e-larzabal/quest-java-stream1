...
public class Shield {
    ...
    public static void main(String[] args) {
        ...
        List<Hero> elders;
        // DO 1 : filter heroes in order to found heroes older than 59
        elders = heroes.stream().filter(item -> item.getAge()>59).collect(Collectors.toList());
        ...
        // DO 2 : filter heroes in order to found heroes that are gluten intolerants
